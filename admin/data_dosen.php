...
$dosen = select_all("SELECT d.*,CONCAT_WS(' ',d.gelar_depan,d.nama_dosen,d.gelar_belakang) as nama_dosen FROM dosen d
                    ORDER BY d.id ASC");
?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="<?= BASE_URL . 'admin/tambah_dosen.php' ?>" class="btn btn-sm btn-success">
                                ...
                                <tbody>
                                    <?php foreach ($dosen as $k => $v) { ?>
                                        <tr>
                                            ...
                                            <td><?= $v['nip'] ?></td>
                                            <td><?= $v['nama_dosen'] ?></td>
                                            <td><span class="badge bg-warning"><?= $v['email'] ?></span></td>
                                            <td><?= $v['no_telepon'] ?></td>
                                            <td>
                                                <a href="<?= BASE_URL . 'admin/edit_dosen.php?id=' . $v['id'] ?>" class="btn btn-sm btn-primary">
